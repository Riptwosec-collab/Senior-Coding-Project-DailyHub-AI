...
const copy = {
  th: {
    ...
    subtitle: "ศูนย์กลางข่าวทั้งหมดของ NimbusDaily แปลไทยก่อนสรุป อ่านข่าวเต็มได้ และส่งข่าวย่อภาษาไทยไป Telegram แบบหนึ่งหัวข้อต่อหนึ่งข้อความ",
  ...
  en: {
    ...
    subtitle: "NimbusDaily's main news center. News is normalized into Thai before summarization, full sources stay readable, and Telegram sends one Thai message per topic.",
