...
export const DATA_LIBRARY_SEED_ITEMS: LibrarySeedItem[] = [
  {
    ...
    source: "NimbusDaily Public Alert Desk",
  ...
  },
  {
    ...
    source: "NimbusDaily Travel Deal Watch",
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "ผลต่อ NimbusDaily", body: "Email Monitor และ Daily Brief ควรแยกข่าวความปลอดภัยเป็นหมวดของตัวเอง พร้อมคะแนน priority และ action ที่ชัดเจน" },
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "Use case", body: "แสดงตารางวันนี้ งานที่ต้องทำ สภาพอากาศ reminder การดื่มน้ำ หรือ dashboard ของ NimbusDaily" },
