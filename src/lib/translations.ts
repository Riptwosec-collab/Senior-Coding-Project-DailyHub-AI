...
export const translations = {
  ...
  en: {
    ...
    dashboard_latest_run_label: "Latest GPT Summary",
    ...
    dashboard_card_from_latest_runs: "from latest summaries",
    ...
    dashboard_no_gpt_results_desc: "Refresh Daily Brief to create a new summary through the API.",
