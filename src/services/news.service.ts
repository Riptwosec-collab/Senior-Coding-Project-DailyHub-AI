...
function buildMockNewsItems(): ThaiNewsArticle[] {
  ...
  return [
    ...
    },
    {
      ...
      action: "เพิ่มหมวด AI Infrastructure ในข่าวและ Data Library",
      publishedAt,
    ...
    {
      source: "Nimbus Research Desk",
      title: "ข้อมูลอ่านเต็มควรสรุปเป็น 3 ระดับ: สั้น กลาง เต็ม",
      description: "คนอ่านแต่ละคนมีเวลาต่างกัน Data Library ควรมีสรุปสั้น ประเด็นสำคัญ และเนื้อหาเต็มในหน้าเดียว",
      fullArticle: "การออกแบบข้อมูลอ่านเต็มควรคิดเหมือนระบบอ่านบทความอัจฉริยะ ไม่ใช่แค่เก็บลิงก์ ควรมีระดับการอ่าน 3 แบบ ได้แก่ 1) สรุป 3 บรรทัดสำหรับ Telegram 2) Key points สำหรับอ่านเร็วบน Dashboard และ 3) Full note สำหรับ Data Library วิธีนี้ทำให้คนอ่านเลือกได้ตามเวลาที่มี และยังทำให้ข้อมูลเหมาะกับการทำโพสต์หรือ presentation ต่อ",
      ...
      publishedAt,
      originalTitle: "Full reads need layered summaries",
    },
    {
      source: "Nimbus Research Desk",
